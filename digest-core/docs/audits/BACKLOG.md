...
|---|---|---|---|---|
| EP-10 | Best-of-N extraction selected by the citation gate — **in PR #86**: `extract.best_of_n` (default 1), gate-as-selector (`llm/best_of_n.py`), pairwise tie-break, `eval-best-of-n` offline proof archived (`baselines/2026-06-11-best-of-n-offline.json`: degraded N=1 recall 0.5 → selected 1.0). Live N/temperature tuning corp-gated (EP-14 ⑧) | W3 | D6 ✅ (ADR-008 v2); EP-12 ✅ (#81/#82); baseline #67 | ACTPULSE-65 |
