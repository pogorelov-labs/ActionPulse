...
> **📖 Для первоначальной установки:** Если вы устанавливаете проект впервые, сначала следуйте корневому **[`README.md`](../../README.md)** — `cd digest-core && make setup` (интерактивный wizard, 7 вопросов). Этот чек-лист предназначен для детального углубленного тестирования после установки.
